...
```python
from hai_agent import Agent, quick_chat
...
```python
from hai_agent import Agent
from hai_agent.providers import OpenAIProvider, OllamaProvider
...
```python
from hai_agent import Agent, tool, FunctionTool
...
```python
from hai_agent import Agent, EventType, EventDispatcher
...
```python
from hai_agent.hooks import emit_hook_async, on_event
...
```python
from hai_agent import Agent, StreamDelta
...
```python
from hai_agent import Agent
from hai_agent.delegation import DelegationManager, TaskSpec
...
# 批量委托
from hai_agent.delegation import DelegationStrategy
...
```python
from hai_agent import Agent, InMemoryProvider, MemoryManager
...
```python
from hai_agent import InMemorySessionProvider
...
```python
from hai_agent import SessionInfo, MessageRecord
...
```python
from hai_agent import SessionProvider, SessionInfo, MessageRecord
...
```python
from hai_agent import Agent, InMemorySessionProvider
