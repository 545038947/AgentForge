...
from hai_agent.memory.memory_store import MemoryStore
from hai_agent.memory.metadata import MemoryType
...
from hai_agent.events import EventType, EventDispatcher

if TYPE_CHECKING:
    from hai_agent.tools import ToolSpec
