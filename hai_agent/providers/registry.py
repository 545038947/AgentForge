...
from hai_agent.providers.base import Provider
...
class ProviderRegistry:
    ...
    def _discover_from_entry_points(cls) -> None:
        ...
        Entry Points 格式：
            [project.entry-points."hai_agent.providers"]
...
def _create_custom_provider_from_config(
    ...
    from hai_agent.providers.profile import ProviderProfile, register_profile
