...
from hai_agent.events import EventDispatcher, EventType
from hai_agent.interrupt import InterruptHandler, InterruptToken
from hai_agent.managers import MessageManager, ToolOrchestrator
from hai_agent.context import ContextCompressor
from hai_agent.tools import Tool, FunctionTool, ApprovalCallback
from hai_agent.tools.guardrails import ToolCallGuardrailController
from hai_agent.types import Message, NormalizedResponse, ToolResult, StreamDelta, ToolCall
from hai_agent.mcp.errors import MCPConnectionError
from hai_agent.types.errors import ProviderError
from hai_agent.types.messages import TextContent, ImageContent, ToolUseContent
...
class Agent:
    ...
    def __init__(
        ...
        if session_id and not session_provider:
            from hai_agent.session import InMemorySessionProvider
        ...
        if skill_registry is None:
            from hai_agent.skills import SkillRegistry
    ...
    def get_memory_tools(self) -> List["Tool"]:
        ...
        from hai_agent.tools.builtins.memory import (
            SaveMemoryTool,
            QueryMemoryTool,
        )
    ...
    def load_skills_from_directory(
        ...
        Returns:
            加载的技能列表
        """
        from hai_agent.skills import SkillLoader
    ...
    def _auto_select_provider(
        ...
        """
        from hai_agent.providers.profile import get_profile, list_profiles
        from hai_agent.providers.registry import ProviderRegistry
        from hai_agent.types.errors import ConfigurationError
