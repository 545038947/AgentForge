...
from hai_agent.types import Message, NormalizedResponse, ToolResult
...
if TYPE_CHECKING:
    ...
    from hai_agent.tools import Tool
...
class ExecutionEngine:
    ...
    def _shrink_images(
        ...
        Returns:
            处理后的消息列表
        """
        from hai_agent.types import ImageContent, TextContent
    ...
    def _shrink_single_image(
        ...
        import base64
        import io
        from hai_agent.types import ImageContent
